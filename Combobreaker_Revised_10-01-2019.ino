...
#define ENCODER1 2 // 5
#define ENCODER2 3 // 6
#define ENCODER_STEPS 300 //Based on the documentation the encoder has 300 steps per rotation
...
//#define MIN_DELAY 400 // Depricated do to the use of microsteps above
